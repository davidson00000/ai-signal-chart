...
def run_multi_simulation(config: MultiSimConfig) -> MultiSimResult:
    ...
    parameters = {
        "timeframe": config.timeframe,
        "strategy_mode": config.strategy_mode,
        "ma_short_window": config.ma_short_window if config.strategy_mode == "ma_crossover" else None,
        "ma_long_window": config.ma_long_window if config.strategy_mode == "ma_crossover" else None,
        "rsi_period": config.rsi_period if config.strategy_mode == "rsi_mean_reversion" else None,
        "rsi_oversold": config.rsi_oversold if config.strategy_mode == "rsi_mean_reversion" else None,
        "rsi_overbought": config.rsi_overbought if config.strategy_mode == "rsi_mean_reversion" else None,
        "initial_capital": config.initial_capital,
        "execution_mode": config.execution_mode,
        "position_sizing_mode": config.position_sizing_mode,
        "use_r_management": config.use_r_management,
